...
if __name__ == '__main__':
    ...
    parser.add_argument('--derain_path', type=str, default="data/Train/Derain/", help='save path of test raining images')
    ...
    ckpt_path = testopt.output_path + testopt.ckpt_name
